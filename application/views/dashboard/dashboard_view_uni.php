	...
	<div class="row">
     ...
     <div class="form-group form-check-inline"> 
          ...
          <div class="form-group d-inline-block"> 
               <input type="submit" class="btn btn-success <?php if(!empty($user_data)){ echo "disabled"; }?>" style="border-radius:0px;" name="uni_submit" value="Submit">
           </div>
           <div class="form-group d-inline-block"> 
               <input type="submit" class="btn btn-danger <?php if(empty($user_data)){ echo "disabled"; }?>" style="border-radius:0px;" name="uni_update" value="Update">
           </div>
         </center>
