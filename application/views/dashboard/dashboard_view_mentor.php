...
<section class="container">		
	...
	<center>
     	...
     	<div class="form-group"> 
               <input type="submit" class="btn btn-success <?php if(!empty($user_data)) {echo 'disabled'; } ?>" style="border-radius:0px;" name="ment_submit" value="Submit">
               <input type="submit" class="btn btn-warning <?php if(empty($user_data)) {echo 'disabled';} ?>" style="border-radius:0px;" name="ment_update" value="Update">
           </div>    
   </center>   
