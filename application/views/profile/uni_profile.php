<main role="main" class="col-md-12 ml-sm-auto col-lg-10 px-4">
	...
	<div class="col-xl-3 col-md-12">
		...
		<a href="<?php echo base_url().'dashboard_controller/university_dashboard'; ?>" name="stu_update" style="border-radius:0px;" class="btn btn-block btn-dark mt-2">Update Details</a>
		</div>
		</div>
	<div class="col-1"></div>
	<div class="col-8 p-2">
 ...
 -->
		...
		<div class="row mt-1">
			<div class="col-md-6">
				<div class="col-md-12"><h4 class="fw-20"><b>Email</b></h4></div>
				<div class="col-md-12"><p class="fw-100"><?php if(!empty($email)){echo $email; }  ?></p></div>
			</div>
			<div class="col-md-6">
				<div class="col-md-12"><h4 class="fw-20"><b>Founder's Day</b></h4></div>
		...
		<div class="row mt-1">
			<div class="col-6">
				<div class="col-sm-12 col-xl-8"><h4 class="fw-20"><b>List Of Colleges</b></h4></div>
				<div class="col-4">
				<ul>
					<li>
           ...
           <li>
			...
			<div class="col-6">
				<div class="col-10"><h4 class="fw-20"><b>Seats Available:</b></h4></div>
				<div class="col-2">
		...
		<div class="row mt-1">
			<div class="col-md-12">
				<div class="col-md-12"><h4 class="fw-20"><b>University Registration Number:</b></h4></div>
