<main role="main" class="col-md-12 ml-sm-auto col-lg-10 px-4">
	...
	<div class="col-xl-3 col-md-12">
		...
		<a href="<?php  echo base_url().'dashboard_controller/mentor_dashboard'; ?>" style="border-radius:0px;" name="stu_update" class="btn btn-block btn-dark mt-2">Update Details</a>

		<a href="<?php echo base_url().'dashboard_controller/delete_ment_profile?id='.$id; ?>" name="stu_delete" class="btn btn-block btn-danger mt-2" style="border-radius:0px;" onclick=" return confirm('Do you really want to delete the record?');">Delete Profile</a>
 ...
 -->
		...
		<div class="row mt-1">
			<div class="col-12">
				<div class="col-md-2"><h4 class="fw-20"><b>Designation</b></h4></div>
